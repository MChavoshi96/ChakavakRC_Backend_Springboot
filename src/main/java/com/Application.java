...
public class Application {
    ...
    CommandLineRunner init(IUserRepository userRepository) {
        ...
        return args -> {
            ...
            UserModel obj = userRepository.findOne("");
            System.out.println(obj);

            UserModel obj2 = userRepository.findByUsername("chakavakrc.ir");
            System.out.println(obj2);

            //obj2.setDisplayAds(true);
            //domainRepository.save(obj2);

            //int n = domainRepository.updateDomain("chakavakrc.ir", true);
            //System.out.println("Number of records updated : " + n);

            //Domain obj3 = domainRepository.findOne(2000001L);
            //System.out.println(obj3);

            //Domain obj4 = domainRepository.findCustomByDomain("google.ir");
